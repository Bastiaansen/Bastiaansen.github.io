  ...
  if(isset($errors)) {
    ...
    $mailtext = "lastname=".$deelnemer["lastname"]."\n"
               ...
               ."institute=".$deelnemer["institute"]."\n"
                ...
                ."presentation=".(($deelnemer["presentation"] == "t") ?   "talk" : (($deelnemer["presentation"] == "gt") ?   "group talk" : "poster"))."\n"
...
."<tr><td>*Form of presentation:</td><td>\n"
    ...
    ."  <input type='radio' id='group presentation' name='presentation' value='gp' ".(($deelnemer["presentation"] == "gp") ? "checked='checked' " : "")."><label for='group presentation'>Group Talk</label><br>\n"
    ...
    ."<tr><td> 
	<strong>When choosing a group talk, please specify your copresenters as additional comment.</strong><br><br>
	<i><strong> What is this group talk you are talking about? </strong> <br>
    This year there is an extra option for the presentation of your research. We are <br>
    giving the option to have a group presentation. By this we mean a group of 2 to 4 <br>
    having similar topics of research and deciding to present together. Those groups <br>
	will have a bonus in the presentation time. <br>
	</strong> </i > <br> <br> <td><td>\n"
...
are not entirely sure if you want to get feedback on your talk or poster we leave <br>
 the choice to you.  <br>  </i > <br> <br> <td><td>\n"
...
function mail_attachment($filename, $path, $mailto, $from_mail, $from_name, $replyto, $subject, $message) {
    ...
    if (mail($mailto, $subject, "", $header)) {
      echo "<h2>Your registration was successful</h2>\n"
          ."<p>Thank you for registering for the <em>PhD days in dynamics and analysis 2017.</em><br>\n"
          ."<br></p>"
